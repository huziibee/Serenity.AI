    ...
    setEntries([
      {
        id: '1',
        date: new Date(),
        content: 'Had a great session at the gym today followed by some meditation. Feeling energized and focused.',
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.scoreCard}>
          ...
          <Text style={styles.scoreSubtext}>Keep writing to earn more points!</Text>
        </View>
